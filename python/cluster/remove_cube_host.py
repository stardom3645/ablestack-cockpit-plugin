...
def remove(args):
    try:
        ...
        with open(ablecloud_file_path, 'w') as outfile:
            ...
            outfile.write('        "gfs_configure": "false",\n')
            outfile.write('        "local_configure": "false"\n')            
            outfile.write('    },\n')
        ...
        if os_type == 'powerflex':
            ...
            with open(cluster_file_path, 'w') as outfile:
                ...
                outfile.write('        "hosts": [\n')
                outfile.write('        ],\n')
                outfile.write('        "extenal_timeserver": "",\n')
                outfile.write('        "iscsi_storage": ""\n')
                outfile.write('    }\n')
                outfile.write('}\n')
