...
$(document).ready(function () {
  ...
  $('#div-accordion-ssh-key').attr('hidden', true).hide();
  $('#div-accordion-cluster-type').attr('hidden', true).hide();
  $('#div-accordion-hosts-file').attr('hidden', true).hide();
  $('#div-accordion-timeserver').attr('hidden', true).hide();
...
$('#button-accordion-cluster-type').on('click', function () {
  if ($('#button-accordion-cluster-type').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-cluster-type').removeAttr('hidden').fadeIn();
    $('#div-accordion-cluster-type').addClass("pf-m-expanded");
    $('#div-accordion-cluster-type').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");
    // 설정확인에서 클러스터 종류 넣기
    ...
    $('#div-accordion-cluster-type').attr('hidden', true).fadeOut();
    $('#div-accordion-cluster-type').removeClass("pf-m-expanded");
    $('#div-accordion-cluster-type').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
    // 설정확인에서 클러스터 종류 넣기
    $('#div-accordion-cluster-type-type').text($('[name="cluster-config-cluster-type-card"].is-selected').find('p:first').text());
  }
});
...
$('#button-accordion-ssh-key').on('click', function () {
  if ($('#button-accordion-ssh-key').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-ssh-key').removeAttr('hidden').fadeIn();
    $('#div-accordion-ssh-key').addClass("pf-m-expanded");
    $('#div-accordion-ssh-key').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");

  } else {
    $('#button-accordion-ssh-key').attr("aria-expanded", "false");
    $('#button-accordion-ssh-key').removeClass("pf-m-expanded");
    $('#div-accordion-ssh-key').attr('hidden', true).fadeOut();
    $('#div-accordion-ssh-key').removeClass("pf-m-expanded");
    $('#div-accordion-ssh-key').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
  }
});
...
$('#button-accordion-hosts-file').on('click', function () {
  if ($('#button-accordion-hosts-file').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-hosts-file').removeAttr('hidden').fadeIn();
    $('#div-accordion-hosts-file').addClass("pf-m-expanded");
    $('#div-accordion-hosts-file').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");
  } else {
    $('#button-accordion-hosts-file').attr("aria-expanded", "false");
    $('#button-accordion-hosts-file').removeClass("pf-m-expanded");
    $('#div-accordion-hosts-file').attr('hidden', true).fadeOut();
    $('#div-accordion-hosts-file').removeClass("pf-m-expanded");
    $('#div-accordion-hosts-file').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
  }
});
...
$('#button-accordion-timeserver').on('click', function () {
  if ($('#button-accordion-timeserver').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-timeserver').removeAttr('hidden').fadeIn();
    $('#div-accordion-timeserver').addClass("pf-m-expanded");
    $('#div-accordion-timeserver').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");
  } else {
    $('#button-accordion-timeserver').attr("aria-expanded", "false");
    $('#button-accordion-timeserver').removeClass("pf-m-expanded");
    $('#div-accordion-timeserver').attr('hidden', true).fadeOut();
    $('#div-accordion-timeserver').removeClass("pf-m-expanded");
    $('#div-accordion-timeserver').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
  }
});
...
function clusterconfigscreenConversion(){
  if ($('#selected-cluster-type').val() == "ablestack-vm"){
    ...
    $('#form-radio-cluster-host-add').prop('disabled', false).closest('.pf-v6-c-radio').removeClass('pf-m-disabled');
    ...
    $('[name="pcs-cluster"]').hide();
    $('[name="pcs-host-pn-ip-all"]').hide();
    $('#form-radio-cluster-host-add').prop('disabled', true).closest('.pf-v6-c-radio').addClass('pf-m-disabled');
