...
$(document).ready(function () {
  ...
  $('#div-accordion-wall-monitoring-ip-info').attr('hidden', true).hide();
  $('#div-accordion-wall-monitoring-smtp').attr('hidden', true).hide();
...
$('#button-accordion-wall-monitoring-ip-info').on('click', function () {
  if ($('#button-accordion-wall-monitoring-ip-info').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-wall-monitoring-ip-info').removeAttr('hidden').fadeIn();
    $('#div-accordion-wall-monitoring-ip-info').addClass("pf-m-expanded");
    $('#div-accordion-wall-monitoring-ip-info').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");
  }
  else {
    ...
    $('#div-accordion-wall-monitoring-ip-info').attr('hidden', true).fadeOut();
    $('#div-accordion-wall-monitoring-ip-info').removeClass("pf-m-expanded");
    $('#div-accordion-wall-monitoring-ip-info').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
  }
});
...
$('#button-accordion-wall-monitoring-smtp').on('click', function () {
  if ($('#button-accordion-wall-monitoring-smtp').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-wall-monitoring-smtp').removeAttr('hidden').fadeIn();
    $('#div-accordion-wall-monitoring-smtp').addClass("pf-m-expanded");
    $('#div-accordion-wall-monitoring-smtp').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");
  }
  else {
    ...
    $('#div-accordion-wall-monitoring-smtp').attr('hidden', true).fadeOut();
    $('#div-accordion-wall-monitoring-smtp').removeClass("pf-m-expanded");
    $('#div-accordion-wall-monitoring-smtp').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
  }
});
...
function setWallIpInput(host_count){
  ...
  var ccvm_el ='';
  ccvm_el +='  <div class="pf-v6-c-form__field-group-header" style="padding-bottom:8px;">';
  ccvm_el +='    <div class="pf-v6-c-form__field-group-header-main">';
  ccvm_el +='      <div class="pf-v6-c-form__field-group-header-title">';
  ccvm_el +='        <div class="pf-v6-c-form__field-group-header-title-text">클라우드센터 VM</div>';
  ccvm_el +='      </div>';
  ccvm_el +='    </div>';
  ccvm_el +='  </div>';
  ccvm_el +='  <div class="pf-v6-c-form__field-group-body" style="padding-top:0px;">';
  ccvm_el +='    <div class="pf-v6-c-form__group" style="padding:0px;">';
  ccvm_el +='      <div class="pf-v6-c-form__group-label">';
  ccvm_el +='        <label class="pf-v6-c-form__label" for="form-input-wall-monitoring-ccvm-ip">';
  ccvm_el +='          <span class="pf-v6-c-form__label-text">CCVM 관리 IP</span>';
  ccvm_el +='          <span class="pf-v6-c-form__label-required" aria-hidden="true">&#42;</span>';
  ccvm_el +='        </label>';
  ccvm_el +='      </div>';
  ccvm_el +='      <div class="pf-v6-c-form__group-control">';
  ccvm_el +='        <input class="pf-v6-c-form-control" style="width:70%" type="text" id="form-input-wall-monitoring-ccvm-ip" name="form-input-wall-monitoring-ccvm-ip" required />';
  ccvm_el +='      </div>';
  ccvm_el +='    </div>';
  ccvm_el +='  </div>';

  var cube_host_el = '';
  cube_host_el += '  <div class="pf-v6-c-form__field-group-header" style="padding-bottom:8px;">';
  cube_host_el += '    <div class="pf-v6-c-form__field-group-header-main">';
  cube_host_el += '      <div class="pf-v6-c-form__field-group-header-title">';
  cube_host_el += '        <div class="pf-v6-c-form__field-group-header-title-text">Cube 호스트</div>';
  cube_host_el += '      </div>';
  cube_host_el += '    </div>';
  cube_host_el += '  </div>';
  cube_host_el += '  <div class="pf-v6-c-form__field-group-body" style="padding-top:0px;">';
  for(var i = 1 ; i <= host_count ; i ++ ){
    cube_host_el += '    <div class="pf-v6-c-form__group" style="padding:0px;">';
    cube_host_el += '      <div class="pf-v6-c-form__group-label">';
    cube_host_el += '        <label class="pf-v6-c-form__label" for="form-input-wall-monitoring-cubehost'+i+'-ip">';
    cube_host_el += '          <span class="pf-v6-c-form__label-text">Cube'+i+' 관리 IP</span>';
    cube_host_el += '          <span class="pf-v6-c-form__label-required" aria-hidden="true">&#42;</span>';
    cube_host_el += '        </label>';
    cube_host_el += '      </div>';
    cube_host_el += '      <div class="pf-v6-c-form__group-control">';
    cube_host_el += '        <input class="pf-v6-c-form-control" style="width:70%" type="text" id="form-input-wall-monitoring-cubehost'+i+'-ip" name="form-input-wall-monitoring-cubehost'+i+'-ip" required />';
    cube_host_el += '      </div>';
    cube_host_el += '    </div>';
  }
  cube_host_el += '  </div>';
  ...
  var scvm_el ='';
  scvm_el +='  <div class="pf-v6-c-form__field-group-header" style="padding-bottom:8px;">';
  scvm_el +='    <div class="pf-v6-c-form__field-group-header-main">';
  scvm_el +='      <div class="pf-v6-c-form__field-group-header-title">';
  scvm_el +='        <div class="pf-v6-c-form__field-group-header-title-text">스토리지센터 VM</div>';
  scvm_el +='      </div>';
  scvm_el +='    </div>';
  scvm_el +='  </div>';
  scvm_el +='  <div class="pf-v6-c-form__field-group-body" style="padding-top:0px;">';
  for(var i = 1 ; i <= host_count ; i ++ ){
    scvm_el +='    <div class="pf-v6-c-form__group" style="padding:0px;">';
    scvm_el +='      <div class="pf-v6-c-form__group-label">';
    scvm_el +='        <label class="pf-v6-c-form__label" for="form-input-wall-monitoring-scvm1-ip">';
    scvm_el +='          <span class="pf-v6-c-form__label-text">SCVM'+i+' 관리 IP</span>';
    scvm_el +='          <span class="pf-v6-c-form__label-required" aria-hidden="true">&#42;</span>';
    scvm_el +='        </label>';
    scvm_el +='      </div>';
    scvm_el +='      <div class="pf-v6-c-form__group-control">';
    scvm_el +='        <input class="pf-v6-c-form-control" style="width:70%" type="text" id="form-input-wall-monitoring-scvm'+i+'-ip" name="form-input-wall-monitoring-scvm'+i+'-ip" required />';
    scvm_el +='      </div>';
    scvm_el +='    </div>';
  }
  scvm_el +='  </div>';
  ...
  var review_el ='';
  review_el +='  <dl class="pf-v6-c-description-list pf-m-horizontal" style="--pf-v6-c-description-list--RowGap: 10px;margin-left: 10px">';
  review_el +='    <div class="pf-v6-c-description-list__group">';
  review_el +='      <dt class="pf-v6-c-description-list__term">';
  review_el +='        <span class="pf-v6-c-description-list__text">호스트 수</span>';
  review_el +='      </dt>';
  review_el +='       <dd class="pf-v6-c-description-list__description">';
  review_el +='        <div class="pf-v6-c-description-list__text">';
  ...
  review_el +='    <div class="pf-v6-c-description-list__group">';
  review_el +='      <dt class="pf-v6-c-description-list__term">';
  review_el +='        <span class="pf-v6-c-description-list__text">클라우드센터 VM</span>';
  review_el +='      </dt>';
  review_el +='       <dd class="pf-v6-c-description-list__description">';
  review_el +='        <div class="pf-v6-c-description-list__text">';
  ...
  review_el +='    <div class="pf-v6-c-description-list__group">';
  review_el +='      <dt class="pf-v6-c-description-list__term">';
  review_el +='        <span class="pf-v6-c-description-list__text">Cube 호스트</span>';
  review_el +='      </dt>';
  review_el +='      <dd class="pf-v6-c-description-list__description">';
  for(var i = 1 ; i <= host_count ; i ++ ){
    review_el +='        <div class="pf-v6-c-description-list__text">';
  ...
  if (os_type == "ablestack-hci" || os_type == "ablestack-hci-filesystem"){
    review_el +='    <div class="pf-v6-c-description-list__group">';
    review_el +='      <dt class="pf-v6-c-description-list__term">';
    review_el +='        <span class="pf-v6-c-description-list__text">스토리지센터 VM</span>';
    review_el +='      </dt>';
    review_el +='      <dd class="pf-v6-c-description-list__description">';
    for(var i = 1 ; i <= host_count ; i ++ ){
      review_el +='        <div class="pf-v6-c-description-list__text">';
