...
$(document).ready(function(){
  ...
  $('#div-accordion-pfmp-vm-device-conifg').attr('hidden', true).hide();
  $('#div-accordion-pfmp-vm-additional').attr('hidden', true).hide();
  $('#div-accordion-pfmp-vm-ssh-key').attr('hidden', true).hide();
...
$('#button-accordion-pfmp-vm-device-conifg').on('click', function(){
  if ($('#button-accordion-pfmp-vm-device-conifg').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-pfmp-vm-device-conifg').removeAttr('hidden').fadeIn();
    $('#div-accordion-pfmp-vm-device-conifg').addClass("pf-m-expanded");
    $('#div-accordion-pfmp-vm-device-conifg').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");
  }
  else {
    ...
    $('#div-accordion-pfmp-vm-device-conifg').attr('hidden', true).fadeOut();
    $('#div-accordion-pfmp-vm-device-conifg').removeClass("pf-m-expanded");
    $('#div-accordion-pfmp-vm-device-conifg').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
  }
});
...
$('#button-accordion-pfmp-vm-additional').on('click', function(){
  if ($('#button-accordion-pfmp-vm-additional').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-pfmp-vm-additional').removeAttr('hidden').fadeIn();
    $('#div-accordion-pfmp-vm-additional').addClass("pf-m-expanded");
    $('#div-accordion-pfmp-vm-additional').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");
  }
  else {
    ...
    $('#div-accordion-pfmp-vm-additional').attr('hidden', true).fadeOut();
    $('#div-accordion-pfmp-vm-additional').removeClass("pf-m-expanded");
    $('#div-accordion-pfmp-vm-additional').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
  }
});
...
$('#button-accordion-pfmp-vm-ssh-key').on('click', function(){
  if ($('#button-accordion-pfmp-vm-ssh-key').attr("aria-expanded") == "false") {
    ...
    $('#div-accordion-pfmp-vm-ssh-key').removeAttr('hidden').fadeIn();
    $('#div-accordion-pfmp-vm-ssh-key').addClass("pf-m-expanded");
    $('#div-accordion-pfmp-vm-ssh-key').closest('.pf-v6-c-accordion__item').addClass("pf-m-expanded");
  }
  else {
    $('#button-accordion-pfmp-vm-ssh-key').attr("aria-expanded", "false");
    $('#button-accordion-pfmp-vm-ssh-key').removeClass("pf-m-expanded");
    $('#div-accordion-pfmp-vm-ssh-key').attr('hidden', true).fadeOut();
    $('#div-accordion-pfmp-vm-ssh-key').removeClass("pf-m-expanded");
    $('#div-accordion-pfmp-vm-ssh-key').closest('.pf-v6-c-accordion__item').removeClass("pf-m-expanded");
  }
});
